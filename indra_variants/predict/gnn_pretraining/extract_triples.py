...
TRIPLE_OUT = os.path.join(DATA_PATH, "triples.csv")
TRIPLE_UNIQUE_OUT = os.path.join(DATA_PATH, "triples_unique.csv")
PATH_OUT = os.path.join(DATA_PATH, "variant_paths.tsv")
...
if __name__ == '__main__':
    df = pd.read_csv(IN_FILE, sep="\t",
                     usecols=["variant_protein", "variant_info", "chain",
